...
yogurt = pd.read_csv('blog/homework4/hw4_questions_files/yogurt_data.csv')
```

```{python}
# Display basic information about the dataset
print("Dataset shape:", yogurt.shape)
print("\nFirst few rows:")
print(yogurt.head())
print("\nColumn names:")
print(yogurt.columns.tolist())

# Analyze purchase patterns
purchase_counts = (yogurt[['y1', 'y2', 'y3', 'y4']].sum())
...
```{python}
#| label: data-reshaping-from-wide-to-long-format
#| echo: true
...
```{python}
#| label: Standard-MNL-Model-Implementation
#| echo: true
...
```{python}
#| label: Latent-class-MNL-implementation
#| echo: true
...
```{python}
#| label: Model-selection-using-BIC
#| echo: true
...
```{python}
#| label: Interpretation-and-Insights
#| echo: true
